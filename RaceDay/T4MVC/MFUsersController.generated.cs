...
{
    public partial class MFUsersController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public MFUsersController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected MFUsersController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public MFUsersController Actions { get { return MVC.MFUsers; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "MFUsers";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "MFUsers";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string mFUser = "mFUser";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/MFUsers/Create.cshtml";
            public readonly string Delete = "~/Views/MFUsers/Delete.cshtml";
            public readonly string Details = "~/Views/MFUsers/Details.cshtml";
            public readonly string Edit = "~/Views/MFUsers/Edit.cshtml";
            public readonly string Index = "~/Views/MFUsers/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MFUsersController : RaceDay.Controllers.MFUsersController
    {
        public T4MVC_MFUsersController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, RaceDay.ViewModels.MFUserViewModel mFUser);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(RaceDay.ViewModels.MFUserViewModel mFUser)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "mFUser", mFUser);
            CreateOverride(callInfo, mFUser);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.ActionResult);
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id, RaceDay.ViewModels.MFUserViewModel mFUser);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(string id, RaceDay.ViewModels.MFUserViewModel mFUser)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "mFUser", mFUser);
            EditOverride(callInfo, id, mFUser);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.ActionResult);
        }
